...
function SignUpScreen() {
  ...
  return (
    ...
    >
      ...
      {/* Continue with email button - Primary CTA */}
      <button 
        ...
        onMouseOver={(e) => e.target.style.backgroundColor = '#4A3CD4'}
        onMouseOut={(e) => e.target.style.backgroundColor = '#5B4AE6'}
      >
      ...
      >
        {/* Divider line above */}
        <div style={{ width: '260px', height: '1px', backgroundColor: '#E5E7EB', marginBottom: '16px' }} />
        <a 
          href="#" 
          style={{ 
            fontSize: '14px',
...
/**
 * Instagram Icon - Uses text-secondary color
 */
...
/**
 * LinkedIn Icon - Uses text-secondary color
 */
...
/**
 * GitHub Icon - Uses text-secondary color
 */
function GitHubIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="#6B7280">
